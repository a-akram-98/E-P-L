...
class KittiDataset(PointCloudDataset):
    ...
    def evaluation(self, detections, output_dir=None , partial=False):
        """
        When you want to eval your own dataset, you MUST set correct
        the z axis and box z center.
        """
        gt_annos = self.ground_truth_annotations
        dt_annos = self.convert_detection_to_kitti_annos(detections , partial)
...
if __name__ == "__main__":
    ...
    data_path = "/content/KITTI_DATASET/"
    info_path = "/content/KITTI_DATASET/kitti_infos_train.pkl"

    from det3d.torchie import Config
    cfg = Config.fromfile("/content/CIA_SSD/examples/second/configs/config.py")
