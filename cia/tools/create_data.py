...
cfg = Config.fromfile("/content/CIA_SSD/cia/examples/second/configs/kitti_car_vfev3_spmiddlefhd_rpn1_mghead_syncbn.py")
...
if __name__ == "__main__":
    #fire.Fire()
    kitti_data_prep("/content/KITTI_DATASET/")
