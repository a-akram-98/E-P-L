...
def parse_args():
    ...
    parser.add_argument("--config", default='/content/CIA_SSD/cia/examples/second/configs/kitti_car_vfev3_spmiddlefhd_rpn1_mghead_syncbn.py', help="test config file path")
    parser.add_argument("--checkpoint", default='/content/cia-ssd-model.pth',  help="checkpoint file")
