...
db_sampler = dict(
    type="GT-AUG",
    enable=True,
    db_info_path=data_root_prefix + "/cia/dbinfos_train.pkl",
...
data_root = data_root_prefix + "/cia"
train_anno = data_root_prefix + "/cia/kitti_infos_train.pkl"
val_anno = data_root_prefix + "/cia/kitti_infos_val.pkl"
test_anno = data_root_prefix + "/cia/kitti_infos_test.pkl"
...
# optimizer
optimizer = dict(type="adam", amsgrad=0.0, wd=0.02, fixed_wd=True, moving_average=False,)
optimizer_config = dict(grad_clip=dict(max_norm=35, norm_type=2))
lr_config = dict(type="one_cycle", lr_max=0.00018, moms=[0.95, 0.85], div_factor=10.0, pct_start=0.4,)  # learning policy in training hooks
...
log_level = "INFO"
work_dir = "/notebooks/"
cp_dir = "/notebooks/E2E/pretrained/cia/"
load_from = None
resume_from = None
