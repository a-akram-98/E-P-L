...
def parse_args():
    ...
    parser.add_argument("--od_cp", default = "/notebooks/E2E/pretrained/cia/E2E_3dod.pth", type = str, help = "Loading Weights for Object Detection model")
...
def train(args):
    ...
    DP_interface = dp_interface(args.depth_cp , '/notebooks/E2E/pretrained/dp')#(args.aanet_pretrained_path , args.Resume_Training , args.ExperimentName , args.dp_cp)
