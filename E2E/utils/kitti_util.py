...
def get_depth_map(idx , samples_paths):
     return gen_depth_map(load_velo_scan(samples_paths[idx]['velo']), Calibration(samples_paths[idx]['calib']), load_image(samples_paths[idx]['left']))
