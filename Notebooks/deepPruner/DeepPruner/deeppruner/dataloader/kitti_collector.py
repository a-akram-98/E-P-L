...
def datacollector(train_filepath, val_filepath, filepath_2012):
    ...
    left_train = []
    right_train = []
    for i , path in enumerate(disp_train_L):
        left_train.append('/notebooks/training/image_2/' + path.split('/')[-1])
        right_train.append('/notebooks/training/image_3/' + path.split('/')[-1])
