...
config = {
    "max_disp": 192,
    "cost_aggregator_scale": 8,#4, # for DeepPruner-fast change this to 8.
    ...
    "feature_extractor_refinement_level_outplanes": 64,#32, # for DeepPruner-fast change this to 64.
